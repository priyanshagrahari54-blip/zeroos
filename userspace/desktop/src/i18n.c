...
static const struct zd_i18n_entry shell_catalog[] = {
    ...
    {"update.rolled_back", "Rolled back safely", "सुरक्षित रूप से रोलबैक हो गया"},
    {"url.blocked_scheme", "This link type is blocked",
     "इस लिंक प्रकार को अवरुद्ध किया गया है"},
    {"url.invalid", "Invalid address", "अमान्य पता"},
    {"snapshot.create", "Create snapshot", "स्नैपशॉट बनाएँ"},
    {"snapshot.restore", "Restore snapshot", "स्नैपशॉट बहाल करें"},
    {"snapshot.failed", "Snapshot failed", "स्नैपशॉट विफल रहा"},
    {"vault.locked", "Vault locked", "वॉल्ट लॉक किया गया"},
