...
|---|---|---|---|
| Desktop modules (display, compositor, window, input, a11y, i18n, search, settings, notify, lifecycle, watchdog, governor, automation, browser, AI, bar, launcher, capability, metrics, update, url, study, fps, snapshot, vault, nav, firewall, sandbox, clipboard, downloads, providers, stress, integration) | `make desktop-check` | 37501 | 0 |
...
| A | Shell (ZERO Bar, launcher, search, notify, settings, clipboard, downloads, providers, overview) | bar/launcher/search/notify/settings/clipboard suites | Core supported; chrome rendering pending |
